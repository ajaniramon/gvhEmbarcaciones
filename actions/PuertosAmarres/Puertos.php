...
class Puertos extends gvHidraForm_DB
{
	public function __construct() {
		...
		$str_select = "SELECT cpuerto as \"lis_cpuerto\", dpuerto as \"lis_dpuerto\", direccion as \"lis_direccion\", telefono as \"lis_telefono\", municipio_cmun as \"lis_municipio_cmun\", num_amarres as \"lis_num_amarres\" FROM puerto";
		...
		//Modo de trabajo FIL
		$this->addMatching("fil_cpuerto", "cpuerto", "puerto");
		$this->addMatching("fil_dpuerto", "dpuerto", "puerto");
		$this->addMatching("fil_direccion", "direccion", "puerto");
		$this->addMatching("fil_telefono", "telefono", "puerto");
		$this->addMatching("fil_municipio_cmun", "municipio_cmun", "puerto");
		$this->addMatching("fil_num_amarres", "num_amarres", "puerto");

		//Modo de trabajo LIS
		$this->addMatching("lis_cpuerto", "cpuerto", "puerto");
		$this->addMatching("lis_dpuerto", "dpuerto", "puerto");
		$this->addMatching("lis_direccion", "direccion", "puerto");
		$this->addMatching("lis_telefono", "telefono", "puerto");
		$this->addMatching("lis_municipio_cmun", "municipio_cmun", "puerto");
		$this->addMatching("lis_num_amarres", "num_amarres", "puerto");
		...
		$this->addFieldType('fil_cpuerto',$string);
		$string = new gvHidraString(false, 5);
		$this->addFieldType('lis_cpuerto',$string);
		
		$string = new gvHidraString(false, 30);
		$this->addFieldType('fil_dpuerto',$string);
		$string = new gvHidraString(false, 30);
		$this->addFieldType('lis_dpuerto',$string);
		...
		$string = new gvHidraString(false, 5);
		$this->addFieldType('fil_municipio_cmun',$string);
		$string = new gvHidraString(false, 5);
		$this->addFieldType('lis_municipio_cmun',$string);
		

		//Integers: gvHidraInteger type
		$int = new gvHidraInteger(false, 4);
		$this->addFieldType('fil_num_amarres',$int);
		$int = new gvHidraInteger(true, 4);
		$this->addFieldType('lis_num_amarres',$int);
		...
		$this->addSlave('Amarres', array('lis_cpuerto',), array('lis_puerto_cpuerto',));		
