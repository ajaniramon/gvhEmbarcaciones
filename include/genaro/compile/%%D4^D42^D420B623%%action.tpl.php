<?php /* Smarty version 2.6.14, created on 2016-03-11 11:30:58
         compiled from patrones/P1M2FIL-EDI/action.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'capitalize', 'patrones/P1M2FIL-EDI/action.tpl', 35, false),array('modifier', 'explode', 'patrones/P1M2FIL-EDI/action.tpl', 191, false),)), $this); ?>
<?php echo '<?php'; ?>
...
$this->_sections['fecha']['last']       = ($this->_sections['fecha']['iteration'] == $this->_sections['fecha']['total']);
 $this->assign('campo', $this->_tpl_vars['fields'][$this->_sections['fecha']['index']]);  $this->assign('reqVal', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['reqVal']);  $this->assign('calVal_fil', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  $this->assign('calVal_edi', $this->_tpl_vars['customFields'][$this->_tpl_vars['campo']]['calVal']);  if ($this->_tpl_vars['types'][$this->_sections['fecha']['index']] == 'gvHidraDate'): ?>
...
');
		...
		$lista_edi = new gvHidraList('edi_<?php echo $this->_tpl_vars['fields'][$this->_sections['components']['index']]; ?>
');
