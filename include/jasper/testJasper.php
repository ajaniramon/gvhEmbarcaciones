<?php
	...
	//1.- Si el fichero NO tiene fuente de datos (estático) usamos
	$ij->setDataSourceType('none');
	//Elegimos el informe
	$ij->setJasperFile('./ejemplos/InformeSinBD/EjemploSinDatos.jasper');
		
	
	//2.- Si el fichero obtiene los datos de una BD relacional y fijamos los parámetros de conexión directamente
	/*
	...
	//Fijamos los parámetros del ejemplo (si es que tiene)
	...
	*/
	...
	/*
	//3.- Si el fichero obtiene los datos de una BD relacional e importamos los parámetros de conexión del PHP
	$PearDSN = array (
		'phptype'   => 'pgsql',
		'username' => 'falete',
	...
	*/
	...
	/*
	//4.- Si el fichero se origina desde código PHP (matrices asociativas)...
	$ij->setDataSourceType('xml');
	//Esta matriz podría venir de distintas colsultas SQL desde el PHP
	$articulos = array (
		array (
				"codlin" =>"TRP-17",
				"desclin" =>"Señal de tráfico autovía",
				"uds" =>"2",
		...
		array (
				"codlin" =>"L3",
				"desclin" =>"La descripción de la línea 3",
				"uds" =>"1",
		...
		array (
				"codlin" =>"L4",
				"desclin" =>"La descripción de la línea 4",
				"uds" =>"1",
	...
	*/
	...
	$ij->disableSupport('chart');//Gráficos
	//$ij->disableSuport('codebars');//Códigos de barras
	
	////////////////////////////////////////////////
	//Forzamos a que el servidor responda en español
	////////////////////////////////////////////////
